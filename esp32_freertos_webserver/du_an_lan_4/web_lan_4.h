        ...
        function pushimg() {
            ...
            xhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                        ...
                        var tam = this.responseText;     

                    if (tam.includes(".png") || tam.includes(".jpg")) {
                                 console.log("in ra");
                                 html.style.background = `url(${tam})`;
...
xhttp.open("GET", "setIMG?IMG=" + pos, true);
xhttp.send();
}
