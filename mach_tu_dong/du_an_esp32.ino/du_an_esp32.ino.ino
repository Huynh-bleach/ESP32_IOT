...
const String tenwifi = "HA-PHUONG";
const String mkwifi = "haphuong123456789";
WebServer server(80);
...
void docdulieudoamdat(){
  ...
  percent  = map(analogValue, 350, 1023, 0, 100);    // Set giá thang giá trị đầu và giá trị cuối để đưa giá trị về thang từ 0-100. 
